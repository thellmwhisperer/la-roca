...
func seedCoreArchive(t *testing.T, db *sql.DB) {
	...
	execTest(t, db, `INSERT INTO tool_uses
		(id, session_id, exchange_number, tool_name, tool_params_summary,
		 had_error, error_message, initiative_type) VALUES
	...
	execTest(t, db, `INSERT INTO thinking_blocks
		(id, session_id, exchange_number, position_in_session, depth, caution_ratio,
		 word_count, is_after_compaction, full_text) VALUES
