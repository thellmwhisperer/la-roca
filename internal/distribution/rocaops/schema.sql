...
-- JSONL is the sole audit destination. These historical rows are not archived.
DROP TABLE IF EXISTS call_history;
DROP TABLE IF EXISTS call_history_segments;
DROP TABLE IF EXISTS call_history_state;
