...
uses. An agent installed after init receives the three embedded skills on the
next ingest. Each installed skill and the generated prompt keep shipped SYSTEM content
